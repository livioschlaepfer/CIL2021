...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='road_seg_single_output_dim_5_5_2021', help='name of the experiment. It decides where to store samples and models')
