...
2. Directories `src/cirterion` and `src/models` contain implementations of different loss functions and model structures used within our experiments. The remaining files in the `src` directory are helpers to the runner files.
